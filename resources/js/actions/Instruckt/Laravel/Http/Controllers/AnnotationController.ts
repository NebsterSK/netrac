 ...
 * @route '/instruckt/resolve-source'
 */
    const resolveSourceForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: resolveSource.url(options),
        method: 'post',
    })
 ...
 * @route '/instruckt/resolve-source'
 */
        resolveSourceForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: resolveSource.url(options),
            method: 'post',
        })
    
    resolveSource.form = resolveSourceForm
/**
 ...
 * @route '/instruckt/screenshots/{filename}'
 */
    const screenshotForm = (args: { filename: string | number } | [filename: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
 ...
 * @route '/instruckt/screenshots/{filename}'
 */
        screenshotForm.get = (args: { filename: string | number } | [filename: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
            action: screenshot.url(args, options),
            method: 'get',
        })
            /**
 ...
 * @route '/instruckt/screenshots/{filename}'
 */
        screenshotForm.head = (args: { filename: string | number } | [filename: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
